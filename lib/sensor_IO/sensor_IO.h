...
//IO:
//Inputs
#define BUTTON_GPIO0_SW2    GPIO_NUM_0         //Button SW2 on GPIO0
#define BUTTON_GPIO15_SW3   GPIO_NUM_15        //Button SW3 on GPIO15
#define INPUT_BITMASK       (1ULL << BUTTON_GPIO15_SW3) | (1ULL << BUTTON_GPIO0_SW2)
//Outputs:
#define PIN_SUPERCAP_ENABLE GPIO_NUM_27
#define RED_LED_ERROR_D1    GPIO_NUM_14        //Red rrror LED on GPIO 14
#define GREEN_LED_STATUS_D2 GPIO_NUM_12       //Green status LED on GPIO12
